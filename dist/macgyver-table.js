...
angular.module("Mac.Table", []);

var __indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; };

angular.module("Mac.Table").factory("TableSectionController", [
  function() {
...
angular.module("Mac.Table").factory("TableRow", function() {
  var TableRow;
...
angular.module("Mac.Table").factory("TableSection", function() {
  var TableSection;
...
angular.module("Mac.Table").factory("TableCell", function() {
  var Cell;
...
angular.module("Mac.Table").factory("tableComponents", [
...
angular.module("Mac.Table").factory("dynamicColumnsFunction", function() {
...
angular.module("Mac.Table").factory("TableColumnsController", [
...
angular.module("Mac.Table").factory("TableRowsController", [
...
angular.module("Mac.Table").factory("Table", [
...
angular.module("Mac.Table").factory("directiveHelpers", [
  function() {
    return {
...
angular.module("Mac.Table").directive("macReorderable", [
...
angular.module("Mac.Table").directive("macReorderableColumns", [
  function() {
    return {
...
angular.module("Mac.Table").directive("macResizable", [
  "hookableDirectiveController", function(hookableDirectiveController) {
    return {
...
angular.module("Mac.Table").directive("macResizableColumn", [
  function() {
    return {
 ...
 */
angular.module("Mac.Table").factory("macColumnsController", function() {
...
angular.module("Mac.Table").directive("macColumns", [
...
angular.module("Mac.Table").directive("macColumnWidth", [
  function() {
    return {
      require: ["^macTable", "^macTableSection", "^macTableRow", "^macColumns"],
      priority: 500,
 ...
 */
angular.module("Mac.Table").directive("macCellTemplate", [
  function() {
    return {
      transclude: "element",
      priority: 1000,
 ...
 */
angular.module("Mac.Table").factory("MacTableRowController", [
...
angular.module("Mac.Table").directive("macTableRow", [
...
macTable
 */
angular.module("Mac.Table").directive("macTableSection", function() {
...
angular.module("Mac.Table").directive("macTableSectionBlankRow", function() {
...
angular.module("Mac.Table").directive("macTableSectionModels", [
...
angular.module("Mac.Table").directive("macTableSectionController", function() {
...
angular.module("Mac.Table").directive("macTableSectionSelectedModels", [
  "$parse", function($parse) {
...
angular.module("Mac.Table").directive("macTableSelectable", [
 ...
 */
angular.module("Mac.Table").factory("MacTableController", [
...
angular.module("Mac.Table").directive("macTable", [
