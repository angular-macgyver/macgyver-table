...
angular.module("Mac.Table").factory "TableRow", ->
  class TableRow
...
angular.module("Mac.Table").factory "TableSection", ->
  class TableSection
...
angular.module("Mac.Table").factory "TableCell", ->
  class Cell
...
angular.module("Mac.Table").factory "dynamicColumnsFunction", ->
  (models) ->
    first   = models[0]
