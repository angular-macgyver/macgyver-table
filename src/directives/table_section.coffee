...
angular.module("Mac.Table").directive "macTableSection", ->
...
angular.module("Mac.Table").directive "macTableSectionBlankRow", ->
...
angular.module("Mac.Table").directive "macTableSectionModels", ["$parse", ($parse) ->
...
angular.module("Mac.Table").directive "macTableSectionController", ->
